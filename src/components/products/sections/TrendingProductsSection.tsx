...
export function TrendingProductsSection({ productId }: TrendingProductsSectionProps) {
  const data = useQuery(api.productSections.getTrendingProducts, { productId });
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-primary/10 rounded-full">
              <TrendingUp className="size-5 md:size-6 text-primary" />
            </div>
            <div>
          ...
          {products.length > 3 && (
            <ScrollNavButtons containerId="trending-products-scroll" />
          )}
        </div>
              ...
              return (
                ...
                >
                  <Card className="border-2 hover:border-primary transition-all hover:shadow-xl overflow-hidden relative">
                    {/* Trending rank badge */}
                    <div className="absolute top-2 right-2 z-10 size-7 md:size-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center font-bold text-sm shadow-lg">
                      #{index + 1}
                    </div>
