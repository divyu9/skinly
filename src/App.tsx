...
// Auth callback - needs immediate load for OAuth flow
import AuthCallback from "./pages/auth/Callback.tsx";
import PaymentCallback from "./pages/payment/callback.tsx";
import NotFound from "./pages/NotFound.tsx";

// Critical pages - lazy loaded for better initial bundle
const Index = lazy(() => import("./pages/Index.tsx"));
const ProductsPage = lazy(() => import("./pages/products/page.tsx"));
const ProductDetailPage = lazy(() => import("./pages/products/detail/page.tsx"));
...
const OrderDetailPage = lazy(() => import("./pages/orders/detail/page.tsx"));
const DevicesPage = lazy(() => import("./pages/devices/page.tsx"));
const AccountPage = lazy(() => import("./pages/account/page.tsx"));
const WalletPage = lazy(() => import("./pages/account/wallet/page.tsx"));
...
const AdminVariantPresetsAutoAssignPage = lazy(() => import("./pages/admin/variant-presets-auto-assign.tsx"));
  ...
  return (
    <HelmetProvider>
      <DefaultProviders>
        ...
        <BrowserRouter>
          <Routes>
          {/* Critical paths - lazy loaded with Suspense */}
          ...
          <Route path="/products/detail" element={<Suspense fallback={<PageSkeleton />}><ProductDetailPage /></Suspense>} />
          <Route path="/products/:slug" element={<Suspense fallback={<PageSkeleton />}><ProductDetailPage /></Suspense>} />
