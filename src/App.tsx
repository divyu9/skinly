...
const AdminBrokenImagesPage = lazy(() => import("./pages/admin/broken-images/page.tsx"));
const AdminAiMockupsPage = lazy(() => import("./pages/admin/ai-mockups/page.tsx"));
...
const MockPaymentPage = lazy(() => import("./pages/mock-payment/page.tsx"));
