...
export const seedHomepage = mutation({
  ...
  handler: async (ctx) => {
    ...
    if (!existingSections) {
      ...
      const sections = [
        {
          sectionType: "hero_slides" as const,
        ...
        {
          sectionType: "models_marquee" as const,
          sectionName: "Supported Models Marquee",
          isActive: true,
          order: 1,
          config: undefined,
        },
        ...
        {
          sectionType: "ugc_videos" as const,
          sectionName: "UGC Videos",
          isActive: false,
          order: 10,
          config: undefined,
        },
