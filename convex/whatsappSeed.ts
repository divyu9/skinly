...
const DEFAULT_USECASES = [
  {
    ...
    description: "Sent immediately after customer places any order",
  ...
  },
  {
    ...
    description: "Sent after COD order is placed with order details and amount to pay",
    isTransactional: true,
    requireConsent: false,
  },
  {
    ...
    description: "Sent after partial COD order (prepayment + COD) is confirmed",
    isTransactional: true,
    requireConsent: false,
  },
  {
  ...
  },
  {
    ...
    description: "Sent after delivery asking customer to review their purchase",
    isTransactional: true,
    requireConsent: false,
  },
  {
    ...
    description: "Follow-up reminder to customers who haven't left a review",
  ...
  },
  {
    ...
    description: "Sent when admin rejects a phone model request",
    isTransactional: true,
    requireConsent: false,
  },
  {
    ...
    description: "Sent when customer requests OTP to verify phone during COD checkout",
    isTransactional: true,
    requireConsent: false,
  },
  {
    ...
    description: "Sent when customer tries to buy an out-of-stock item",
    isTransactional: true,
    requireConsent: false,
  },
  {
    ...
    description: "Sent when customer requests OTP to verify their phone number",
    isTransactional: true,
    requireConsent: false,
  },
  {
  ...
  },
  {
    ...
    description: "Sent with updates on return request status",
    isTransactional: true,
    requireConsent: false,
  },
  {
  ...
  },
  {
    ...
    description: "Sent when price drops on products customer viewed",
    isTransactional: false,
    requireConsent: true,
  },
  {
    ...
    description: "Sent to re-engage inactive customers with special offers",
    isTransactional: false,
    requireConsent: true,
  },
  {
    ...
    description: "Sent on customer's birthday with special discount",
    isTransactional: false,
    requireConsent: true,
  },
  {
